...
function custom_override_checkout_fields( $fields ) {
  ...
  $fields['billing']['billing_address_1']['placeholder'] = 'Ví dụ: Số xx Đường xx Thủ Đức, TP.HCM';
  ...
  $fields['shipping']['shipping_address_1']['placeholder'] = 'Ví dụ: Ví dụ: Số xx Đường xx Thủ Đức, TP.HCM';
